...
@Entity
@Table(name = "encyclopedia_comment")
public class EncyclopediaComment implements Serializable {
	 ...
	 * 评论id
	 */
	@Column(nullable = false,length = 36, name = "comment_id")
	private String commentId;
	/**
	 * 百科id
	 */
	@Column(nullable = false,length = 36, name = "encyclopedia_id")
