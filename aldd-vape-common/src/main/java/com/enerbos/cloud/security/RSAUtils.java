package com.enerbos.cloud.security;
 ...
 * password1 = RSAUtils.encryptedString(key, pwd1);
 *
...
//        return (new File(urlPath).getParent() + RSA_PAIR_FILENAME);
        //因spring boot无法获取当前目录，所以改用系统临时目录
        return props.getProperty("java.io.tmpdir") + RSA_PAIR_FILENAME;
    }
    ...
    private static void saveKeyPair(KeyPair keyPair) {
        ...
        try {
            ...
            try {
                ...
                logger.error("Unable to close resource: {}", var2);
            }
            try {
                oos.close();
            } catch (Exception var2) {
